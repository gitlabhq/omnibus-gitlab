...
module License
  class Analyzer
    @license_acceptable = Regexp.union([/MIT/i, /LGPL/i, /Apache/i, /Ruby/i, /BSD/i,
                                        ...
                                        /OFL-1.1/, /SIL OPEN FONT LICENSE/i, /BlueOak-1\.0\.0/i])
    ...
    @software_acceptable = [
      ...
      'gitlab-artifact_registry-client', # GitLab EE license (first-party gem at ee/gems/ in gitlab-org/gitlab) - https://gitlab.com/gitlab-org/gitlab/-/merge_requests/246861
