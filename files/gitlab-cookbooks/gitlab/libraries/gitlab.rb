...
module Gitlab
  ...
  class << self
    ...
    def generate_secrets(node_name)
      ...
      Gitlab['mattermost']['email_invite_salt'] ||= generate_hex(64)
      Gitlab['mattermost']['file_public_link_salt'] ||= generate_hex(64)
      Gitlab['mattermost']['email_password_reset_salt'] ||= generate_hex(64)
