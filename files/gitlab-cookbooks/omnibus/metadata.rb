...
license 'Apache 2.0'
description "Base GitLab omnibus cookbook for installing and configuring GitLab"
long_description "Base GitLab omnibus cookbook for installing and configuring GitLab"
version '0.1.0'
