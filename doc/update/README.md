...
NOTE: **Note:**
Zero downtime updates **do not work** when updating from 12.0.x to any 12.1 release prior to `12.1.11`. Please use the latest
`12.1.x` release when updating. If you depend on zero downtime updates and have any concerns, please [contact support](https://about.gitlab.com/support/).
