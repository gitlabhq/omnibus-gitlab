...
already using a PostgreSQL 11 database. For more information, please see which [PostgreSQL versions are shipped with an Omnibus install](https://docs.gitlab.com/ee/administration/package-information/postgresql_versions.html).
