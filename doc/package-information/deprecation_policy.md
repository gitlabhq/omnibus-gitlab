...
1. Create an issue at the [omnibus-gitlab issue tracker][] with details on deprecation type and other necessary information
...
1. WIP MR removing the configuration OR details on what needs to be done
