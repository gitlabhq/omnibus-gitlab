...
This project creates full-stack platform-specific Linux packages for GitLab.
For other installation options please see the [GitLab installation page][install-about].
...
Please follow the steps of the [install documentation][install-docs].
...
See [doc/settings/ldap.md](https://docs.gitlab.com/administration/auth/ldap/).
...
See [doc/settings/environment-variables.md](doc/settings/environment-variables.md).
