...
describe 'gitlab::redis' do
  let(:chef_run) { ChefSpec::SoloRunner.new(step_into: %w(redis sentinel_service account)).converge('gitlab-ee::default') }
  ...
  describe 'When sentinel is disabled' do
    ...
    it_behaves_like 'disabled runit service', 'sentinel', 'root', 'root', 'gitlab-redis', 'gitlab-redis'
  end
