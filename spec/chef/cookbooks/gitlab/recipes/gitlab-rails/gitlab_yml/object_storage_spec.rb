...
RSpec.describe 'gitlab::gitlab-rails' do
  ...
  describe 'object storage settings' do
    ...
    describe 'individual object storage settings' do
      ...
      include_examples 'renders object storage settings in gitlab.yml', 'agent_plan_content', { remote_directory: 'agent-plan-content' }, false
      include_examples 'renders object storage settings in gitlab.yml', 'ci_catalog_bundles', { remote_directory: 'ci-catalog-bundles' }, false
