...
RSpec.describe 'crond_job' do
  context 'crond enabled' do
    ...
    context 'delete' do
      cached(:chef_run) { runner.converge("crond::enable", "test_crond::crond_job_delete") }
    ...
    context 'minimal' do
      cached(:chef_run) { runner.converge("crond::enable", "test_crond::crond_job_minimal") }
  ...
  context 'crond disabled' do
    ...
    context 'delete' do
      cached(:chef_run) { runner.converge("test_crond::crond_job_delete") }
    ...
    context 'minimal' do
      cached(:chef_run) { runner.converge("test_crond::crond_job_minimal") }
