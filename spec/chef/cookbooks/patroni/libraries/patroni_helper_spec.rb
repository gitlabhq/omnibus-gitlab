require 'chef_helper'
require 'gitlab_ctl/patroni'

RSpec.describe PatroniHelper do
  describe 'RUNNING_STATES' do
    it 'stays in sync with GitlabCtl::Patroni::RUNNING_STATES' do
      expect(PatroniHelper::RUNNING_STATES).to eq(GitlabCtl::Patroni::RUNNING_STATES)
    end
  end
